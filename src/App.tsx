  ...
  return (
    <div ref={mainRef} className="relative">
      ...
      <main className="relative pt-16">
        ...
        {/* Section 3: Automation Stream - pin: false */}
        <section id="logs" className="relative z-30">
          <AutomationStream />
        </section>
        
        {/* Section 4: Dispatch Tracking - pin: false */}
        <section id="dispatch" className="relative z-40">
          <DispatchTracking />
        </section>
      </main>
    </div>
